document.addEventListener('DOMContentLoaded', function(){
    ...
    function startCollisionDetection () {
        let isAliveInterval = setInterval(function (){
            ...
            //detect collision
            if(hazardLeft <200 && hazardLeft >170 && blockTop >= 250) {
                console.log("BlockTop:", blockTop, "HazardLeft:", hazardLeft);
                clearInterval(scoreInterval);
                endGame();
            }
        }, 10)
    ...
    function jump() {
        ...
        if (!block.classList.contains("jump")) {
